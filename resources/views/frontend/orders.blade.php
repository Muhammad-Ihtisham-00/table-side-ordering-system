  ...
  <body>
      ...
      <div class="container-fluid">
        <a class="navbar-brand" href="#" style="color: white">
          ...
          >
            ...
            />
          </svg><span style="margin-left: 10px">Orders</span>
        </a>
        <button
    ...
    <div class="container ms-0" style="margin-top: 100px">
      <div class="row mb-4">
          ...
          <div class="card">
            <table class="table">
              <thead style="background-color: #dc3545">
                <tr>
                  <th scope="col" style="color: white">Tracking #</th>
                  <th scope="col" style="color: white">Table #</th>
        ...
        <tr>
          <th scope="row">{{$order->tracking_no}}</th>
        ...
        @endif</td>
          <td><a href="{{route('myOrder.details',$order->id)}}" class="btn btn-success">view</a></td>
        </tr>
        @endforeach
